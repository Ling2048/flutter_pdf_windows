#include "include/flutter_pdf_windows/flutter_pdf_windows_plugin.h"
...
class FlutterPdfWindowsPlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrarWindows *registrar);

  FlutterPdfWindowsPlugin();

  virtual ~FlutterPdfWindowsPlugin();
...
// static
void FlutterPdfWindowsPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows *registrar) {
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "flutter_pdf_windows",
          &flutter::StandardMethodCodec::GetInstance());

  auto plugin = std::make_unique<FlutterPdfWindowsPlugin>();
...
FlutterPdfWindowsPlugin::FlutterPdfWindowsPlugin() {}

FlutterPdfWindowsPlugin::~FlutterPdfWindowsPlugin() {}

void FlutterPdfWindowsPlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue> &method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
...
void FlutterPdfWindowsPluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  FlutterPdfWindowsPlugin::RegisterWithRegistrar(
